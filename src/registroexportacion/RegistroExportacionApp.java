...
public class RegistroExportacionApp {
    ...
    private static void ingresarMultiplesExportaciones(){
     ...
     do {
        ...
        // Valida si deseas continuar
        while (true) {
            System.out.print("¿Desea ingresar otro registro? (S/N): ");
            try {
                continuar = InputValidador.validateContinuar(entradaUsuario.nextLine());
                break;
    ...
    private static void ingresarexportacion() {
        String id = null, nombre = null, tipoExportacion = null, zona = null, servicio = null;
        double kg = 0;
